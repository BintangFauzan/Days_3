...
import com.example.days_3.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String user_login = getIntent().getStringExtra("USERNAME");
        ...
        Toast.makeText(getApplicationContext(),"Welcome"+user_login,Toast.LENGTH_SHORT).show();
